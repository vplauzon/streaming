...
{
    public class BatchOneByOneThroughputScenario : ScenarioBase
    {
        private readonly int _threadCount;
        private readonly TimeSpan _samplingTime;

        public BatchOneByOneThroughputScenario(string connectionString, bool isAmqp, int threadCount, TimeSpan samplingTime)
